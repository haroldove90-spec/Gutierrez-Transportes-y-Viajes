...
export const ROUTE_STOPS: RouteStop[] = [
  ...
  { 
    ...
    mapsUrl: 'https://maps.app.goo.gl/Ji9UMZtn3uwVphgu8', 
    order: 7, 
    timeOffsetMins: 270, 
    isActive: true,
    isSpecialPoint: false,
...
export const INITIAL_VEHICLES: Vehicle[] = [
  ...
  {
    id: 'veh-auto-01',
    unitNumber: 'Unidad 09 (Sedán Ejecutivo)',
    model: 'Volkswagen Vento Comfortline 4 Pax',
    plate: '73-VZ-1M',
    capacity: 4,
    category: 'auto',
    status: 'active',
  ...
  {
    id: 'veh-cam-01',
    unitNumber: 'Unidad 10 (Camión 3.5T)',
    model: 'Isuzu ELF 400 Carga & Paquetería',
    plate: '84-CM-3P',
    capacity: 3,
    category: 'camion',
    status: 'active',
  ...
  {
    id: 'veh-bus-01',
    unitNumber: 'Unidad 11 (Autobús 45)',
    model: 'Irizar i6 Plus / Scania 45 Pax',
    plate: '55-AB-7R',
    capacity: 45,
    category: 'autobus',
    status: 'active',
